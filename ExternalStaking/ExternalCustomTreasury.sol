...
contract wGbchCustomTreasury is Ownable {
     ...
     *  @param _amount uint
     */
    function sendPayoutTokens( address _recipient, uint _amount ) external {
        require(bondContract[msg.sender], "msg.sender is not a bond contract");
        IERC20(payoutToken).safeTransfer( _recipient , _amount );
    }
